...
const OPERATOR_NAME = "김태우";
const CONTACT_EMAIL = "xodn159357@gmail.com";
...
export default function PrivacyPolicyPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-12 text-gray-800">
      ...
      <nav aria-label="목차" className="mb-12 rounded-lg border bg-gray-50 p-5">
      ...
      <section id="s7" className="mb-10 scroll-mt-20">
        ...
        <ul className="list-disc space-y-2 pl-6 leading-relaxed">
          ...
          <li>
            <strong>관리적 조치</strong>: 개인정보 취급 담당자
            최소화, 정기적인 자체 점검
          </li>
          <li>
